...
hi DiffText        guifg=#8ae234 ctermfg=113 guibg=#4e9a06 ctermbg=64 gui=none
...
hi Folded		guibg=#000000 ctermbg=0 guifg=#FFFFFF ctermfg=15 gui=bold
hi vimFold		guibg=#000000 ctermbg=0 guifg=#FFFFFF ctermfg=15 gui=bold
hi FoldColumn	guibg=#000000 ctermbg=0 guifg=#FFFFFF ctermfg=15 gui=bold

hi LineNr		guifg=#535353 ctermfg=239 guibg=#202020 ctermbg=234
hi NonText		guifg=#535353 ctermfg=239 guibg=#202020 ctermbg=234
hi Folded		guifg=#535353 ctermfg=239 guibg=#202020 ctermbg=234 gui=bold
hi FoldeColumn  guifg=#535353 ctermfg=239 guibg=#202020 ctermbg=234 gui=bold
...
hi Statement	guifg=#ffffff ctermfg=15 gui=bold
hi PreProc		guifg=#ffffff ctermfg=15 gui=bold
hi Type			guifg=#8ae234 ctermfg=113 gui=bold
...
hi Todo			guifg=#FFFFFF ctermfg=15 guibg=#ef5939 ctermbg=203 gui=bold
...
hi cppSTLType   guifg=#729fcf ctermfg=74 gui=bold
...
hi TabLineSel	guifg=#FFFFFF ctermfg=15 gui=bold
